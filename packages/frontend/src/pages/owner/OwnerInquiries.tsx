        ...
        >
            {isLoading ? (
                ...
                <div className="space-y-3">
                    {inquiries.map((inq, i) => {
                        const inqId = (inq._id || inq.id || i).toString();
                        const isExpanded = expanded === inqId;
                        ...
                        return (
                            ...
                            >
                                <div
                                    className="flex items-center justify-between p-4 gap-4 flex-wrap cursor-pointer hover:bg-muted/30 transition-colors"
                                    onClick={() => setExpanded(isExpanded ? null : inqId)}
                                >
                                    ...
                                    <div className="flex items-center gap-2 shrink-0">
                                        ...
                                        <Button
                                            ...
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                setExpanded(isExpanded ? null : inqId);
                                            }}
                                        >
                                            <ChevronDown
