...
import type { CartItem as _CartItem, OfferBanner as _OfferBanner, Order as _Order, OrderStatus as _OrderStatus, Product as _Product, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBanner(arg0: OfferBanner): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addBanner(to_candid_OfferBanner_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getActiveBanners(): Promise<Array<OfferBanner>> {
        if (this.processError) {
            try {
    ...
    async updateBanner(arg0: bigint, arg1: OfferBanner): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBanner(arg0, to_candid_OfferBanner_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_OfferBanner_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OfferBanner): OfferBanner {
...
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OfferBanner>): Array<OfferBanner> {
    return value.map((x)=>from_candid_OfferBanner_n13(_uploadFile, _downloadFile, x));
}
...
function to_candid_OfferBanner_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OfferBanner): _OfferBanner {
